            ...
            [
                ...
                'children' => [
                    [
                        ...
                        'name' => 'Stock Movement',
                        'slug' => '/manage/stock-movement',
                        'type' => '',
                        'language' => ['lang' => 'kh', 'name' => 'ចលនាភាគហ៊ុន'],
                        'description' => 'Operation management',
                        'status' => true,
                        'type' => 'menu',
                        'icon' => '<i class="fas fa-users menu-icon"></i>',
                        ...
                        'slug' => '/manage/brands',
                        'type' => 'menu',
                        'language' => ['lang' => 'kh', 'name' => 'ម៉ាក'],
                        'description' => 'Operation management',
                        'status' => true,
                        'icon' => '<i class="fas fa-tags menu-icon"></i>',
                        ...
                        'type' => '',
                        'language' => ['lang' => 'kh', 'name' => 'អ្នកផ្គត់ផ្គង់'],
                        'description' => 'Operation management',
                        'status' => true,
                        'type' => 'menu',
                        'icon' => '<i class="fas fa-users menu-icon"></i>',
                        ...
                        'type' => '',
                        'language' => ['lang' => 'kh', 'name' => 'ការទូទាត់'],
                        'description' => 'Operation management',
                        'status' => true,
                        'type' => 'menu',
                        'icon' => '<i class="fas fa-users menu-icon"></i>',
                        ...
                        'type' => '',
                        'language' => ['lang' => 'kh', 'name' => 'ការចំណាយ'],
                        'description' => 'Operation management',
                        'status' => true,
                        'type' => 'menu',
                        'icon' => '<i class="fas fa-users menu-icon"></i>',
