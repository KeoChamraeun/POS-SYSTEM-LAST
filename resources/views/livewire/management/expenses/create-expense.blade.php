        ...
        <div class="modal-content rounded-4 shadow border-0">
            <div class="modal-header bg-danger text-white rounded-top-4">
                <h5 class="modal-title fw-bold">
                    <i class="fas fa-hand-holding-dollar me-2"></i> Record New Expense
                </h5>
            ...
            <form wire:submit.prevent="save">
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold">Amount ({{ strtoupper(config('app.currency', 'USD')) }}) <span class="text-danger">*</span></label>
                ...
                <div class="modal-footer bg-light rounded-bottom-4">
                    ...
                    <button type="submit" class="btn btn-danger px-5" wire:loading.attr="disabled">
