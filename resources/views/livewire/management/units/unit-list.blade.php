<div class="container-fluid">
    <div class="row align-items-center g-3 mb-4">
        <div class="col-md-6">
            <h3 class="mb-0 fw-bold text-dark">
                <i class="fas fa-ruler me-2" style="color: #6c757d;"></i>
                {{ __('Units') }}
            </h3>
        </div>
        <div class="col-md-6 text-md-end">
            <button type="button" class="btn btn-primary" wire:click="openCreateUnitModal">
                <i class="fas fa-plus me-2"></i> {{ __('Add Unit') }}
            </button>
        </div>
    </div>
    ...
    <!-- Modals -->
    <livewire:management.units.create-unit />
    <livewire:management.units.update-unit />
</div>