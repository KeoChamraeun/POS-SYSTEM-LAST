<div class="modal fade" id="updateSupplierModal" tabindex="-1" aria-labelledby="updateSupplierModalLabel" wire:ignore.self data-bs-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content rounded-4 shadow">
            <div class="modal-header bg-primary rounded-top-4 px-4 py-3 border-bottom-0">
                <h5 class="modal-title fw-bold" id="updateSupplierModalLabel">
                    <i class="fas fa-truck-loading me-2 text-dark"></i> {{ __('Edit Supplier') }}
                </h5>
...
document.addEventListener('livewire:init', () => {
    Livewire.on('open-update-supplier-modal', () => {
        bootstrap.Modal.getOrCreateInstance(document.getElementById('updateSupplierModal'))?.show();
    });
    Livewire.on('close-update-supplier-modal', () => {
        bootstrap.Modal.getOrCreateInstance(document.getElementById('updateSupplierModal'))?.hide();
    });
});
</script>