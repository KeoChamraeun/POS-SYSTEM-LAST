<div class="modal fade" id="updateCustomerModal" tabindex="-1" aria-labelledby="updateCustomerModalLabel" wire:ignore.self data-bs-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content rounded-4 shadow">
            <div class="modal-header bg-primary rounded-top-4 px-4 py-3 border-bottom-0">
                <h5 class="modal-title fw-bold" id="updateCustomerModalLabel">
                    <i class="fas fa-user-edit me-2 text-dark"></i> {{ __('Edit Customer') }}
                </h5>
...
document.addEventListener('livewire:init', () => {
    Livewire.on('open-update-customer-modal', () => {
        bootstrap.Modal.getOrCreateInstance(document.getElementById('updateCustomerModal'))?.show();
    });
    Livewire.on('close-update-customer-modal', () => {
        bootstrap.Modal.getOrCreateInstance(document.getElementById('updateCustomerModal'))?.hide();
    });
});
</script>