<div>
    <div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true" wire:ignore.self data-bs-backdrop="static" data-bs-keyboard="false">
                        ...
                        <div class="row g-5"> 
                            <div class="col-lg-4 d-flex flex-column align-items-center border-end">
                                <div class="mb-4 w-100 text-center">
                                    ...
                                    @error('img') <div class="small text-danger mt-1">{{ __($message) }}</div> @enderror 
                                    <div class="rounded-circle overflow-hidden border shadow-sm mx-auto" style="width:120px; height:120px; background:#f8f9fa;">
                                        <img src="{{ $img ? $img->temporaryUrl() : asset('assets/icon/profile.png') }}" class="img-fluid h-100 w-100 object-fit-cover">
                                    </div>
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            Livewire.on('close-add-user-modal', () => {
