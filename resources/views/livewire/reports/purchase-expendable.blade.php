<div class="container-fluid">
    <div class="d-flex justify-content-center align-items-center flex-column"> 
        ...
        <h4 class="fw-bold text-center text-truncate mt-2"> {{__('Purchase/Receive of Expendable Report')}}</h4>
                ...
                <table class="table table-striped table-hover table-bordered border-secondary align-middle mb-0" style="min-width: 1800px;">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-start">{{ __('Pur. Date') }}</th>
                            <th class="text-center">{{ __('Name of Expendable') }}</th>
