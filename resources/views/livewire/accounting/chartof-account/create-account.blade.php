<div class="modal fade" id="openModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true"
    wire:ignore.self>
        ...
        <div class="modal-content rounded-4 shadow-lg border-0">
            <div class="modal-header bg-light border-bottom-0 rounded-top-4 px-4 py-3">
                <h4 class="modal-title fw-bold text-dark" id="addUserModalLabel">
                    <i class="fas fa-plus me-2"></i> {{ __('New Chart of Account') }}
                </h4>
                        ...
                        <div class="col-lg-12">
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    @error('abbreviation') <div class="small text-danger mt-1">{{ __($message) }}</div>
                                    @enderror
                                </div>
